...
def main(argv: list[str] | None = None) -> int:
    ...
    # Inside src/generate_documentation.py under main() execution tracking:
    use_prisma = args.use_gemini or bool(os.getenv("PRISMA_AI_API_KEY"))
    if use_prisma:
        from prisma_enricher import enrich_with_prisma
        markdown = enrich_with_prisma(
            markdown,
            git_data,
            source_branch=metadata.source_branch,
            target_branch=metadata.target_branch,
        ...
        print("Applied Prisma AI enrichment.")
